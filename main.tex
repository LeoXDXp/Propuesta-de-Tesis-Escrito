...
\vspace{.5cm}
Los m\'etodos actuales para analizar las redes mencionadas se basan en el procesamiento directo de im\'agenes obtenidas a partir de microscop\'ia, y utilizando diversas t\'ecnicas como esqueletonizaci\'on (Figura \ref{Fig1c}), la transformada de Rad\'on o {\it template matching}. Esto permite identificar los filamentos de forma individual, o el grafo que representa a la red (Figura \ref{Fig1d}).
...
% Aquello permitir\'ia pasar de Fig1d a Fig1f por ejemplo
...
% pasar de Fig1d a Fig1e o Fig1f
